...
#define RT_VERSION_DUP                      3L              /**< major version number */
#define RT_SUBVERSION                   1L              /**< minor version number */
#define RT_REVISION                     3L              /**< revise version number */

/* RT-Thread version */
#define RTTHREAD_VERSION                ((RT_VERSION_DUP * 10000) + \
...
struct rt_object
{
    char       name[RT_NAME_MAX_DUP];                       /**< name of kernel object */
...
{
    /* rt object */
    char        name[RT_NAME_MAX_DUP];                      /**< the name of thread */
...
#define rt_thread_t tb_thread_ref_t
...
#elif defined(AOE_REFACTORING)
//typedef struct tb_semaphore_ref_t *rt_sem_t;
//#define rt_semaphore tb_semaphore_impl_t
#define rt_sem_t tb_semaphore_ref_t
...
#elif defined(AOE_REFACTORING)
//typedef struct tb_mutex_ref_t *rt_mutex_t;
#define rt_mutex_t tb_mutex_ref_t
...
typedef struct rt_uart_device *rt_device_t;
#endif
